...
public class TxnCancelAdapter extends RecyclerView.Adapter<TxnCancelAdapter.ViewHolder> {
    ...
    public TxnCancelAdapter(List<RecyclerItem> recyclerItems, OnItemClickListener onItemClickListener, Context context1) {
    ...
    @NonNull
    @Override
    public TxnCancelAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.txn_cancel_item, parent, false);
        return new ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull TxnCancelAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (recyclerItem.getCustno() != null && recyclerItem.getCustno() != null) {
            holder.tv_agent_id.setText(recyclerItem.getAgentId() + "/" + recyclerItem.getCustno());
        } else {
            holder.tv_agent_id.setText("");
            holder.ll_agent_id.setVisibility(View.GONE);
        }
        ...
        holder.ll_animation.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.tv_header_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout ll_animation, ll_expand_collapse;
        LinearLayout ll_branch_id_name, ll_account_no, ll_date_time, ll_customer_name, ll_balance,
                ll_overdue, ll_amount, ll_ref_no, ll_agent_id;

        AppCompatTextView tv_header_server_rrn, tv_header_account_no, tv_header_amount, tv_header_cancel;
        AppCompatTextView tv_branch_id_name_label, tv_branch_id_name, tv_account_no_label, tv_account_no,
                tv_date_time_label, tv_date_time, tv_customer_name_label, tv_customer_name,
                tv_balance_label, tv_balance, tv_overdue_label, tv_overdue, tv_amount_label, tv_amount,
                tv_ref_no_label, tv_ref_no, tv_agent_id_label, tv_agent_id;

        ViewHolder(View itemView) {
            super(itemView);

            ll_animation = itemView.findViewById(R.id.ll_animation);
            ...
            ll_agent_id = itemView.findViewById(R.id.ll_agent_id);
            ...
            tv_header_cancel = itemView.findViewById(R.id.tv_header_cancel);
            ...
            tv_agent_id = itemView.findViewById(R.id.tv_agent_id);
        }
    }
}
