...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    private static final String IIB_DB_NAME = "TUTINIT.db";
    private static final String OUT_DB_NAME = "out.db";
    private static final String ENTITIES_DB_NAME = "indusind_entities.db";
    private SQLiteDatabase myDataBase;
    private final Context myContext;
    public final String DB_PATH = Environment.getExternalStorageDirectory()
            + "/Android/";
    // String DB_PATH =null;
    ...
    private DBAdapter(Context context) {
        super(context, IIB_DB_NAME, null, 1);
    ...
    private boolean checkDataBase() {
        ...
        try {
            String myPath = DB_PATH + IIB_DB_NAME;
        ...
        try {
            String myPath = DB_PATH + OUT_DB_NAME;
            checkDB = SQLiteDatabase.openDatabase(myPath, null,
                    SQLiteDatabase.OPEN_READONLY);
        ...
        try {
            String myPath = DB_PATH + ENTITIES_DB_NAME;
            checkDB = SQLiteDatabase.openDatabase(myPath, null,
                    SQLiteDatabase.OPEN_READONLY);
    ...
    private void copyDataBase() throws IOException {
        ...
        InputStream myInput = myContext.getAssets().open(IIB_DB_NAME);
        // Path to the just created empty db
        String outFileName = DB_PATH + IIB_DB_NAME;
        ...
        // Open your local db as the input stream
        myInput = myContext.getAssets().open(OUT_DB_NAME);
        // Path to the just created empty db
        outFileName = DB_PATH + OUT_DB_NAME;
        // Open the empty db as the output stream
        ...
        // Open your local db as the input stream
        myInput = myContext.getAssets().open(ENTITIES_DB_NAME);
        // Path to the just created empty db
        outFileName = DB_PATH + ENTITIES_DB_NAME;
        // Open the empty db as the output stream
        myOutput = new FileOutputStream(outFileName);
        // transfer bytes from the inputfile to the outputfile
        buffer = new byte[1024];
     ...
     * @throws SQLException
     */
    public void openDataBase_IIB_DB_NAME() throws SQLException {
        String myPath = DB_PATH + IIB_DB_NAME;
     ...
     * @throws SQLException
     */
    public void openDataBase_OUT_DB_NAME() throws SQLException {
        String myPath = DB_PATH + OUT_DB_NAME;
        myDataBase = SQLiteDatabase.openDatabase(myPath, null,
                SQLiteDatabase.OPEN_READWRITE);
    }
     ...
     * @throws SQLException
     */
    public void openDataBase_ENTITIES_DB_NAME() throws SQLException {
        String myPath = DB_PATH + ENTITIES_DB_NAME;
        myDataBase = SQLiteDatabase.openDatabase(myPath, null,
                SQLiteDatabase.OPEN_READWRITE);
    }
    ...
    public int getTranslatesCount(String userid, String password) {
        String countQuery = "SELECT  * FROM userinfo where userid='" + userid
