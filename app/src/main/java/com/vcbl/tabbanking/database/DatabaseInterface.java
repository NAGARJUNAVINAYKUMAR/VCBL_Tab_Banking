...
/**
 * Created by Balajee on 16-11-2017.
 */
...
public class DatabaseInterface extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.vcbl.tabbanking/databases/";
    ...
    public static synchronized  DatabaseInterface getInstance(Context context) throws IOException{
...
//-------------------------------------------------------------------------------------------------
    ...
    private DatabaseInterface(Context context) throws IOException {
        super(context, Constants.DB_NAME, null, 1);
        this.mContext = context;
        mDbPath = this.mContext.getDatabasePath(Constants.DB_NAME).toString();
